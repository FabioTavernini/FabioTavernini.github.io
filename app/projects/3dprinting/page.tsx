  ...
  },
  {
    ...
    upgrades: [
      ...
      },
      {
        ...
        description: "Faster heat-up times and better thermal performance.",
      },
      {
        label: "Klipper firmware",
        url: "https://www.printables.com/model/389830-neo-thang",
...
export default function Page() {
  return (
    <div className="flex flex-col">
      <h2 className="mb-10 bg-gradient-to-r from-yellow-400 to-red-600 text-transparent bg-clip-text font-bold text-2xl leading-2 sm:text-2xl sm:tracking-tight ">
        3D-Printing
      </h2>
                ...
                <ul className="ml-5 list-disc text-base mt-2">
                  {printer.upgrades.map((upgrade, uIdx) => (
                    <li key={uIdx} className="mb-2">
                      <Link
                        className={
                          upgrade.url.endsWith(".jpg") ? "text-blue-600" : ""
                        }
                        href={upgrade.url}
                        rel="noopener"
                        target="_blank"
        ...
        <CardBody>
          <ul className="text-left m-5">
            <li>
              <Link
                className="text-xl"
                href="https://www.thingiverse.com/ftave/designs"
              >
                Thingiverse page
              </Link>
              ...
              <ul className="list-disc ml-10">
                <li>
                  <Link
                    href="https://www.thingiverse.com/thing:6911226"
                    target="_blank"
                  >
                    Gridfinity SFP holder
                  </Link>
                </li>

                <li>
                  <Link
                    href="https://www.thingiverse.com/thing:6944060"
                    target="_blank"
                  >
                    E30 Dash USB Charger
                  </Link>
                </li>

                <li>
                  <Link
                    href="https://www.thingiverse.com/thing:7075834"
                    target="_blank"
                  >
                    Remix of Raspberry Pi Holder
                  </Link>
                </li>

                <li>
                  <Link
                    href="https://www.thingiverse.com/thing:5923376"
                    target="_blank"
                  >
                    Alfa romeo GTV6 Radio cover
                  </Link>
                </li>

                <li>
                  <Link
                    href="https://www.thingiverse.com/thing:6911332"
                    target="_blank"
                  >
                    Zyxel switch rack mount
                  </Link>
                </li>
              </ul>
            </li>
